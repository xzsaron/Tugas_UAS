...
<head>
	...
	<title>Home - SD KARYA DEWI PUTRA</title>
...
<body>
	<div class="container bg-light">
		...
		<div class="logo clearfix">
			<div class="float-left mt-3 mb-3">
				...
				<div class="text float-right">
					<span class="smk">SD KARYA DEWI PUTRA</span><br>
					<span class="visi">Mewujudkan SD Berkarakter, Berkompeten dan Unggul.</span>
				</div>
			</div>
		</div>
		...
		<!-- hero image -->
		<div class="hero">
			<img src="resources/images/Haldepan2.jpg" alt="">
		</div>
